    ...
    <section class="recent-projects" style="padding:15px 0px 10px;">
        <div class="auto-container">
            <div class="row clearfix">
                ...
                <h3 class="inner-title" style="position:relative;text-transform:none;font-weight:300;padding:15px 0px 0px 0px;">Trending <span style="font-weight:bold;">Used Phone</span><a name="Used">&nbsp;</a></h3>
				</div>
           		...
           		<div id="box-hover" class="inner-box" style="position:relative;height:343px;">
	                   ...
	                   <article class="inner-box" style="position:relative">
                        ...
                        <div class="content-box">
                           ...
                           <div class="text flash" style="font-weight: 600;font-size: 14px;color:#fe3f3f;"><?php if($row['current_stock']<=0){ echo  $row['yearbyadmin'];}else{ echo $row['yearbyadmin'];}?> <?php if($img_logo=="Admin"){?><span class="logoname" ><img src="images/admin-icon.png" style="width:auto;height:30px;"></span><?php } ?></div>
...
where soum_product_master.brand=	soum_prod_subcat.prod_subcat_id
and soum_product_master.modal= soum_prod_subsubcat.prod_subsubcat_id
and soum_product_master.active=1 ".$cond1." ".$cond2." ".$cond;
								//echo $qry;
								$stmt = $db->prepare($qry);
							    $bindTypeStringArray =array() ;
							    $bindTypeStringArray[] = $bindType;
								...
								$total_pages = ceil($total_records / $num_rec_per_page);
                                   for ($i=1; $i<=$total_pages; $i++)
									...
									echo "<li><a class=".$class." href='phones.php?page=".$i."&".$params1."'>".$i."</a></li>";
                                   }
                                   ?>
                                <li><a class="<?php if($active==$total_pages){ $class='active';} else { $class='next1';} ?>" href='phones.php?page=<?=$total_pages."&".$params1;?>'>Last&ensp;<span class="fa fa-angle-right"></span></a></li>
                            </ul>
            </div>
		 </div>
            <!-- Styled Pagination -->
