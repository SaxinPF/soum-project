...
<link href="css-old/bootstrap-margin-padding.css" rel="stylesheet">
<link href="css-old/responsive.css" rel="stylesheet"`>
<!--[if lt IE 9]><script src="http://html5shim.googlecode.com/svn/trunk/html5.js"></script><![endif]-->
<!--[if lt IE 9]><script src="js/respond.js"></script><![endif]-->
<link href="css-old/multi_level_form_css.css" rel="stylesheet" type="text/css"/>
<style>
 ...
 function tab_click(val)
  {
  	...
  	if(val==1)
  	{
			$("#button"+val).css("background-color","#3376bb");
		...
		<div class="row clearfix">
			<div class="row">
				...
				<div class="column col-md-12 col-sm-12 col-xs-12" id="mobile-title"><a name="used" id="used"></a>
                     <a class="navbar-brand" href="<?php echo SITEPATH; ?>"><img src="img/logo.jpg" alt=""/></a>
					<h1 style="line-height: 1;margin-top: 8px;text-align:center;" class="mobile-des1">CROSS-VERIFY YOUR <span style="color:#000;font-weight: 800;">ADVERTISEMENT</span></h1>
                 ...
                 <div class="col-md-12">
                 	<div style="width:100%;float:left;border-bottom: 2px solid #3376bb!important;" id="remove1">
						<input name="Button1"  class="bkg-tab" style="background:#3376bb!important; color:#fff;" type="button" value="Choose Your Brand" id="button1" onclick="tab_click(1)">
									...
									<div class="col-md-12" style="padding:0px;background-color:#fff;padding-top:15px;">
										...
										<div class="col-md-6">
											<div class="col-md-12" style="padding:0px;padding-top:0px;">
												<div class="col-md-12" style="padding:0px;font-size: 20px;color: #3376bb;font-weight: bold;">
												...
												<input type="text" class="form-control" id="admin_year" name="admin_year" value="<?=$admin_year;?>"/>
															...
															<div class="tab-pane active" id="tab-justified-home">
																<div class="clearfix" id="box-color">
																	...
																	<?php
																	  ...
																	  ?>
																	  value="<?=$rowi['issue_id']?>" type="checkbox" style="color:#3376bb;font-size:15px;margin-right:10px;"><?=$rowi['issue']?></label></p>
																	  <?php } ?>
																</div>
															</div>
														</div>
														...
														<div class="tab-content">
															<div class="tab-pane active" id="tab-justified-home">
																<div class="clearfix" id="box-color">
																	...
																	Accessories:</h4>
																	  ...
																	  ?>
																	  value="<?=$rowi['access_id']?>" type="checkbox" style="color:#3376bb;font-size:15px;margin-right:10px;"><?=$rowi['access_name']?></label></p>
																	  <?php } ?>
																			</div>
															</div>
														</div>
														 <div class="tab-content">
															<div class="col-md-6">
												              <p style="font-weight:bold">ROM</p>
																<select class="form-control minimal" name="mrom" id="exampleFormControlSelect1">
																	 <?php
														...
														<div class="col-md-12" style="display:none">
														    ...
														    <div class="col-md-6" style="padding-left:0px;">
																  <p style="font-weight:bold">Colour</p>
																	<select class="form-control minimal" name="color_id" id="color_d">
																	 <option value='' >Select</option>
																		 <?php
					...
					<div id="d4" class ="d" style="display:none">
					   <div class="clearfix" style="padding:20px;">
									<div class="col-md-7" style="padding:0px;">
										...
										<?php if($poster_type=='Dealer' || $poster_type=='Admin'){ ?>
											<div class="box-img" style="overflow: hidden;margin-bottom:10px;"><a id="rmv4" style="display:none" onclick="remove_img(4)" class="remove-img">X</a>
												<span class="select-img1" id="saler-id" style="background: rgb(195, 195, 195,0.3);width:100% !important;cursor:pointer;float: left;z-index: 9;height: 80px;text-align:center;background-size:100px auto;background-repeat:no-repeat;background-position:center center;"><img src="upload/<?=$image4;?>" id="previewing4" style="height:80px;width: auto;margin: auto;float: none;"/></span><span class="select-wrapper"><input name="fileToUpload4"  id="fileToUpload4" onchange="abc(this,4);" class="btn btn-default" type="file" style="width:100% !important;margin-bottom:13px;text-align:left;padding:20px 5px;border: 1px dashed #c5d7b5;height: 80px !important;" ></span>
				                            ...
				                            <div class="box-img" style="padding-left:0px;overflow: hidden;margin-bottom:10px;"><a id="rmv5" style="display:none" onclick="remove_img(5)" class="remove-img">X</a>
				                            	<span class="select-img1" id="saler-id" style="background: rgb(195, 195, 195,0.3);width:100% !important;cursor:pointer;float: left;z-index: 9;height: 80px;text-align:center;background-size:100px auto;background-repeat:no-repeat;background-position:center center;"><img src="upload/<?=$image5;?>" id="previewing5" style="height:80px;width: auto;margin: auto;float: none;"/></span><span class="select-wrapper"><input name="fileToUpload5" id="fileToUpload5" onchange="abc(this,5);" class="btn btn-default" type="file" style="width:100% !important;margin-bottom:13px;text-align:left;padding:20px 5px;border: 1px dashed #c5d7b5;height: 80px !important;" ></span>
				                            ...
				                            <div class="box-img" style="padding-left:0px;overflow: hidden;margin-bottom:10px;"><a id="rmv6" style="display:none" onclick="remove_img(6)" class="remove-img">X</a>
				                            	<span class="select-img1" id="saler-id" style="background: rgb(195, 195, 195,0.3);width:100% !important;cursor:pointer;float: left;z-index: 9;height: 80px;text-align:center;background-size:100px auto;background-repeat:no-repeat;background-position:center center;"><img src="upload/<?=$image6;?>" id="previewing6" style="height:80px;width: auto;margin: auto;float: none;"/></span><span class="select-wrapper"><input name="fileToUpload6" id="fileToUpload6" onchange="abc(this,6);" class="btn btn-default" type="file" style="width:100% !important;margin-bottom:13px;text-align:left;padding:20px 5px;border: 1px dashed #c5d7b5;height: 80px !important;"></span>
									...
									<div class="col-md-5" id="remove1">
										<div style="width:100%;float:left;background-color:#f9f9f9;padding: 20px;padding-top: 0px;display:none;">
								        ...
								        <div class="col-md-12" style="padding-left:0px;">
											...
											<span style="float:left;width:auto;margin-right:15px;"><label>Rating*</label></span>
										      <span style="float:left;width:auto;margin-top: 4px;"> <input name="star1" type="radio" value="5" class="star"/>
...
<div class="scroll-to-top scroll-to-target" data-target=".page-wrapper"><span class="fa fa-long-arrow-up"></span></div>
	<link rel="stylesheet" href="soumadmin/styles/plugins/bootstrap-datepicker.css">
...
<script src='js-old/star/jquery.MetaData.js' type="text/javascript" language="javascript"></script>
 <script src='js-old/star/jquery.rating.js' type="text/javascript" language="javascript"></script>
 <link href='js-old/star/jquery.rating.css' type="text/css" rel="stylesheet"/>



<script src="js-old/owl.js"></script>
<script src="js-old/wow.js"></script>
<script src="js-old/script.js"></script>
<script src="js-old/jquery.min.js" type="text/javascript"></script>
<script src="js-old/jquery.maskedinput.js" type="text/javascript"></script>
	<script src="soumadmin/scripts/plugins/select2.min.js"></script>
	<script src="soumadmin/scripts/plugins/bootstrap-colorpicker.min.js"></script>
	<script src="soumadmin/scripts/plugins/bootstrap-slider.min.js"></script>
	<script src="soumadmin/scripts/plugins/summernote.min.js"></script>
	<script src="soumadmin/scripts/plugins/bootstrap-datepicker.min.js"></script>
	<script src="soumadmin/scripts/form-elements.init.js"></script>
   ...
   $.ajax({
          ...
          //alert(data);
           ...
           if(data==3)
            ...
            window.location.href="soumadmin/dashboard.php";
          }
...
function bill(val)
{
 warr=val;
  if(val==1)
   {
   document.getElementById('admin_year').value='Warranty Over';
    // $("#billdate").show();
   }
   else
   {
   document.getElementById('admin_year').value='';
     //$("#billdate").hide();
   }
  ...
  if(warr=='')
  {
    ...
    return false;
	 ...
	 if(warr==2)
	 {
		  if(year=='')
		  {
		   // alert('Please fill Billing date');
		   // return false;
		  }
	 }
...
/*   if(mrom==undefined)
  ...
  {
    alert('first image must be uploaded');
    return false;
  }
