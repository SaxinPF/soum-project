...
<body>
 ...
 <div class="clearfix"></div>
  <div class="mainhead container">
				...
				?>
				<div class="headslog"><h1><?php echo $banner_desc; ?><span><?php echo $banner_desc2; ?></span></h1> <a class="seehowmuch" href="<?php echo $banner_link; ?>" role="button"><?php echo $banner_btn; ?></a></div>
				<div class="clearfix"></div>
...
$res=$sql->get_result();
            ...
            <div class="homephones item" >
				 <div onclick="window.location.href='<?php echo SITEPATH. slugify($row['brand'].'-'.$row['model']).'-'.$row['prod_id'];?>'" style="cursor:pointer;">
				     ...
				     <div class="prodtl"><?php echo $row['brand'];?> <?php echo $row['model'];?> <span style="margin-bottom:0px;">₹ <?php if($row['appliable_rate']<=$row['offer_price']){echo $row['appliable_rate'];}else{echo $row['offer_price'];}?>/-</span></div>
