			...
			<div class="page page-dashboard">
				...
				<div class="page-wrap" style="min-height:450px;">
					...
					<div class="row">
						...
						<div class="col-md-12" style="margin-top:20px;">
							<div class="dash-head clearfix mb20">
								<div class="left">
									<h3 class="mb5 text-light" style="margin-top: 0px;">Finance</h3>
								</div>
					...
					<div id="box-new" class="col-md-12">
                        ...
                        <div class="col-md-3 col-sm-6">
    						<div class="panel panel-default mb20 mini-box panel-hovered">
								<a href="bill_of_supply.php">
								<div class="panel-body">
									<div class="clearfix">
										<div class="info left" >
											<h4 class="mt0 text-primary text-bold" style="font-size: 30px;text-align:center"></h4>
											<h5 class="text-light mb0" style="font-size:18px;">Sale</h5>
										</div>
										<div class="right ion ion-ios-person-outline icon"></div>
									</div>
								</div>
						  ...
						  <div class="col-md-3 col-sm-6">
    						<div class="panel panel-default mb20 mini-box panel-hovered">
								<a href="repair_receipt_note.php">
								<div class="panel-body">
									<div class="clearfix">
										<div class="info left" >
											<h4 class="mt0 text-primary text-bold" style="font-size: 30px;text-align:center"></h4>
											<h5 class="text-light mb0" style="font-size:18px;">Repair Receipt</h5>
										</div>
										<div class="right ion ion-ios-person-outline icon"></div>
									</div>
								</div>
						...
						<div class="col-md-3 col-sm-6">
    						<div class="panel panel-default mb20 mini-box panel-hovered">
								<a href="bill_receipt_stock.php">
								<div class="panel-body">
									<div class="clearfix">
										<div class="info left" >
											<h4 class="mt0 text-primary text-bold" style="font-size: 30px;text-align:center"></h4>
											<h5 class="text-light mb0" style="font-size:18px;">Stock Report</h5>
										</div>
										<div class="right ion ion-ios-person-outline icon"></div>
									</div>
								</div>
