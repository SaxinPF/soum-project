...
if($search!='')
{
 ...
 if($on==2)
 {
  $cond.="and soum_product_master.seller_name like '%$search%'";
 }
 if($on==3)
 {
					...
					<div class="row">
						...
						<div class="col-md-12" style="margin-top:30px;">
							<div class="dash-head clearfix mb20">
                                ...
                                <div>
                                <a class="btn btn-primary mr5 waves-effect" href="admin_adv.php?act=add" style="margin:0px;padding:6px 80px;float:right;">Add new</a>
                                </div>							</div>						</div>					</div>

                  <?php include('admin_adv_ele.php');?>
					...
					<div class="clearfix tabs-fill">
								...
								<div class="tab-content table-responsive">
									...
									if($type!='')
									{
								    $cond.=" and soum_product_master.poster_type='$type' and soum_product_master.trash!='delete' and soum_product_master.category_type='phone'";
									}
								...
								/* 	  echo '<pre>';
									...
									?>
										<tr>
											...
											<td><?=$row['prod_type'];?></td>
											<td>
											<a class="link btn-primary" href="phone_detail.php?prod_id=<?=$row['prod_id'];?>&poster_id=<?=$row['poster_id'];?>&type=<?=$type;?>">Details</a>
											<a class="link btn-primary Edit" href="admin_adv.php?req_id=<?=$row['prod_id']?>&amp;act=edit" style="margin:0px;padding: 2px 12px;" >Edit</a>
