				...
				<div class="page-wrap">
					<div class="row">
						...
						<div class="col-md-12" style="margin-top:20px;">
							<div class="dash-head clearfix mb20">
                                ...
                                <div>
                                <a href="dealer_master.php?act=add"><button class="btn btn-primary mr5 waves-effect" type="submit" style="margin:0px;padding:6px 80px;float:right;">Add new</button></a></tr>
        						</div>
							</div>
						</div>
					</div> <!-- #end row -->
					...
					<div class="row">
						...
						?>
                                        ...
                                        <tr><form method="get">
											<td><input name="search" value="<?=$_REQUEST['search'];?>" type="text" class="form-control">
												</td><td><button name="Submit1" type="submit" value="Search" class="btn btn-primary mr5 waves-effect">Search</button></td></form>
											</tr>
										</table>								<div class="col-md-12 table-responsive" style="padding:0px;">
									...
									while($row1=$res->fetch_assoc())
									  {
										...
										<tr>
											...
											<td style="padding: 5px;">
											   ...
											   <a href="https://www.soum.in/dealer_login.php?dealer=<?php echo  base64_encode($row1['cust_id']); ?>" class="link btn-primary">Login</a>
