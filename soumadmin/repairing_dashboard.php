...
<body id="app" class="app off-canvas">
	...
	<div class="main-container clearfix">
		<!-- main-navigation -->
		<?php include('_repairing-left.php');?>
		<!-- #end main-navigation -->
								...
								<div class="panel-body">
									<div class="clearfix">
										<div class="info left">
											...
											<h5 class="text-light mb0" style="font-size:18px;">Repairing</h5>
										</div>
								...
								<div class="panel-pink panel">
									...
									<div class="panel-collapse collapse in" id="collapseTwo5">
										...
										<div style="width:100%;float:left;padding:22px;background-color:rgba(255,255,255,0.7);">
											<div class="col-md-6">
												<div class="white-box"> 
													<div class="track-order"> <div class="track-logo transition"> <img src="../images/barcod-icon.png" style="float:left;"><h3 class="box-heading">Track Your Package</h3>
											...
											<div class="col-md-6" >
										        <div id="lastcenter-detail">
								                    <div class="white-box" style="padding:8px;width:90%;height:auto;margin:auto;float:none;padding-top:0px;">
