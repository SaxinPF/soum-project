					...
					<div class="row">
						...
						<div class="col-md-12" style="margin-top:30px;">
							<div class="dash-head clearfix mb20">
								<div class="left">
									<h4 class="mb5 text-light"><a name="top">Airpod Model Master</a></h4>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="col-md-12">
							<div class="dash-head clearfix mb20 table-responsive">
								...
								<table class="auto-style2" id="list-1" style="width: 100%;font-size:13px !important">
									...
									<tbody>
								<?php
								$sql="select soum_product_master.* from soum_product_master where  trash != 'delete' and soum_product_master.category_type='airpod' ".$cond;
								// echo $sql;
								// exit;
								$res=$db->query($sql);
								$i=1;
