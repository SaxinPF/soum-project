				...
				<div class="page-wrap" style="min-height:450px;">
					...
					<div class="row">
						...
						<div class="col-md-12" style="margin-top:20px;">
							<div class="dash-head clearfix mb20">
								<div class="left">
									<h3 class="mb5 text-light" style="margin-top: 0px;">Admin Adv Master</h3>
								</div>
					...
					<div id="box-new" class="col-md-12">
						<div class="col-md-3 col-sm-6">
						  ...
						  <?php
					  $type = 'Admin';
                      $sql="select if (count(1) =0,0,sum(if (active,0,1))) not_approved_adv , count(1) total_adv from soum_product_master where poster_type='$type' and soum_product_master.category_type ='phone' and soum_product_master.trash!='delete'";
                      $res=$db->query($sql);
                      $row=$res->fetch_assoc();
                      ?>
						...
						<div class="col-md-3 col-sm-6">
							<div class="panel panel-default mb20 mini-box panel-hovered">
								...
								<div class="panel-body">
									<div class="clearfix">
										<div class="info left" >
											<h4 class="mt0 text-primary text-bold" style="font-size: 30px;text-align:center">0</h4>
                        ...
                        <div class="col-md-3 col-sm-6">
							  <?php
					  $type = 'Admin';
                      $sql="select if (count(1) =0,0,sum(if (active,0,1))) not_approved_adv , count(1) total_adv from soum_product_master where poster_type='$type' and soum_product_master.category_type ='cable' and soum_product_master.trash!='delete'";
                      $res=$db->query($sql);
                      $row=$res->fetch_assoc();
                      ?>
							...
							<div class="panel panel-default mb20 mini-box panel-hovered">
								...
								<div class="panel-body">
									<div class="clearfix">
										<div class="info left" >
											<h4 class="mt0 text-primary text-bold" style="font-size: 30px;text-align:center">0</h4>
											<h5 class="text-light mb0" style="font-size:18px;">Airpods</h5>
										</div>
										<div class="right ion ion-ios-person-outline icon"></div>
									</div>
								</div>
							...
							<div class="panel panel-default mb20 mini-box panel-hovered">
								...
								<div class="panel-body">
									<div class="clearfix">
										<div class="info left" >
											<h4 class="mt0 text-primary text-bold" style="font-size: 30px;text-align:center">0</h4>
											<h5 class="text-light mb0" style="font-size:18px;">Headphones & Earphones</h5>
										</div>
										<div class="right ion ion-ios-person-outline icon"></div>
									</div>
								</div>
							...
							<div class="panel panel-default mb20 mini-box panel-hovered">
								...
								<div class="panel-body">
									<div class="clearfix">
										<div class="info left" >
											<h4 class="mt0 text-primary text-bold" style="font-size: 30px;text-align:center">0</h4>
											<h5 class="text-light mb0" style="font-size:18px;">Home Tech</h5>
										</div>
										<div class="right ion ion-ios-person-outline icon"></div>
									</div>
								</div>
