...
<body id="app" class="app off-canvas body-full">
	...
	<header class="site-head" id="site-head" style="top: 0;width: 100%;margin-left: 0;margin-top:0x;display:block;">
		...
		<div class="main-container clearfix" style="top:43%;">
			...
			<div class="page page-auth">
				...
				<div class="auth-container">
					...
					<div class="form-head mb20">
						...
						<h1 class="site-logo h2 mb5 mt5 text-center text-uppercase text-bold" style="font-size: 20px"><a href="index.php">Dealer / Buyer Seller Login</a></h1>
