...
if($row['model']==0){
  $model = $row['other_model'];
	 ...
	 <tr>
		...
		<td width="20%" style="margin-top:0;padding-bottom:4px;font-size:14px;margin-top:0; padding-bottom:4px;font-size:14px;border-top:1px solid gray;border-left:1px solid gray;border-right:1px solid gray;text-align:right;" ><strong>Token Number: </strong></td>
        ...
        <table class="customer-info">
            <tbody>
                ...
                <tr>
	               ...
	               <p style="font-size:15px;text-align:left;padding-right:30px;">Signature of Buyer_______________</p>
