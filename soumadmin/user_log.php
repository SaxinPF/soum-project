				...
				<div class="page-wrap">
					<div class="row">
						...
						<div class="col-md-12">
							<div class="dash-head clearfix mb20" style="margin-top:30px;">
								<div class="left">
									<h4 class="mb5 text-light">User Log of <b><?=$name;?></b></h4>
								</div>
							</div>
						</div>
					</div> <!-- #end row -->					
					<div class="row">
						...
						<table class="table table-bordered invoice-table mb30" id="list-1">
									...
									$sql="select * from soum_login_log where login_type='Customer' and login_by=$uid";									
									
									$res=$db->query($sql);
									$i=1;
									while($row=$res->fetch_assoc())
									{
										$ldate=$row['login_date'];
										$old= date("d-m-Y h:i:s A", strtotime($ldate));

									?>
										<tr>
											<td style="padding: 5px;"><?=$i++;?></td>
											<td style="padding: 5px;"><?=$old;?></td>
										</tr>										
									<?php 
									}	
									?>
