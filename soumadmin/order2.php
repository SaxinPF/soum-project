					...
					<div class="row">
						<div class="col-md-12">
							<div class="dash-head clearfix mb20">
								<div class="left">
									<h3 class="mb5 text-light" style="margin-top:0px;">Order List (Gadgets)</h3>
								</div>
								...
								<div class="tab-content table-responsive" style="width: 100%;float: left;">
									...
									<?php
									  ...
									  $type=$_REQUEST['type'];
								        ...
								        $qry="select *,soum_order_master.exchange ex1, soum_order_master.category_type ord_category_type,soum_order_details.price price1,soum_prod_subcat.prod_subcat_desc brand,concat(soum_prod_subcat.prod_subcat_desc,' ',soum_product_master.modal_name ) phone1 from
										soum_order_master, soum_order_details,
										soum_product_master,soum_prod_subcat
										...
										<?php } ?></td>
											...
											<?php } ?>
											 ...
											 <td><a href="order_detail2.php?order_id=<?=$row['order_id'];?>&type=<?=$type;?>&pid=<?=$prod_id;?>">Details</a></td>
										</tr>
									<?php
									}
