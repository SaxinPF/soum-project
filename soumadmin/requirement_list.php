					...
					<div class="row">
						...
						<div class="col-md-12" style="margin-top:20px;">
							<div class="dash-head clearfix mb20">
								<div class="left">
									<h3 class="mb5 text-light" style="margin-top: 0px;">Phone Requirement</h3>
								</div>
					...
					<div id="box-new" class="col-md-12">
						<div class="col-md-3 col-sm-6">
							<div class="panel panel-default mb20 mini-box panel-hovered">
								<a href="buyer_requirement.php">
								<div class="panel-body">
									<div class="clearfix">
										<div class="info left" >
											<h4 class="mt0 text-primary text-bold" style="font-size: 30px;text-align:center"></h4>
											<h5 class="text-light mb0" style="font-size:18px;">Buyer Requirement</h5>
										</div>
						...
						<div class="col-md-3 col-sm-6">
							<div class="panel panel-default mb20 mini-box panel-hovered">
								<a href="saler_requirement.php">
								<div class="panel-body">
									<div class="clearfix">
										<div class="info left" >
											<h4 class="mt0 text-primary text-bold" style="font-size: 30px;text-align:center"></h4>
											<h5 class="text-light mb0" style="font-size:18px;">Seller Requirement</h5>
										</div>
										<div class="right ion ion-ios-person-outline icon"></div>
									</div>
								</div>
						...
						<div class="col-md-3 col-sm-6">
							<div class="panel panel-default mb20 mini-box panel-hovered">
								<a href="repair_requirement.php">
								<div class="panel-body">
									<div class="clearfix">
										<div class="info left" >
											<h4 class="mt0 text-primary text-bold" style="font-size: 30px;text-align:center"></h4>
											<h5 class="text-light mb0" style="font-size:18px;">Repair Requirement</h5>
										</div>
										<div class="right ion ion-ios-person-outline icon"></div>
									</div>
								</div>
						...
						<div class="col-md-3 col-sm-6">
							<div class="panel panel-default mb20 mini-box panel-hovered">
								<a href="exchange_requirement.php">
								<div class="panel-body">
									<div class="clearfix">
										<div class="info left" >
											<h4 class="mt0 text-primary text-bold" style="font-size: 30px;text-align:center"></h4>
											<h5 class="text-light mb0" style="font-size:18px;">Exc Requirement</h5>
										</div>
										<div class="right ion ion-ios-person-outline icon"></div>
									</div>
								</div>
