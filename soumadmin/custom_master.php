						     ...
						     <!-- tab style -->
									<div class="clearfix tabs-fill">
											...
											<div class="tab-content">
												<div class="tab-pane active table-responsive" id="tab-flip-one-1">
									...
									<tr>
										...
										<td><?=$dt;?></td>
										<td><?php echo $rowd['brand_name'].' '.$rowd['prod_name']; ?></td>
					...
					<div class="row">
						...
						<div class="clearfix tabs-fill">
											...
											<ul class="nav nav-tabs" style="margin-bottom: -4px;">
												<li class="active"><a href="#tab-flip-dispatched" data-toggle="tab">Dispatched </a></li>

											</ul>
											<div class="tab-content" style="width: 100%;float: left;">

								<div class="tab-pane active" id="tab-flip-dispatched">
									<div class="col-md-12" style="padding:0px;">
											<table class="table table-bordered invoice-table mb30" id="list-1">
																<thead>
																	<tr style="background: #38b4ee;color: #fff">
																		...
																		<th style="padding: 5px;width:80px;">Action</th>
																	</tr>
																</thead>
																<tbody>
																<?php
																...
																$sql1="select *,(SELECT count(1) FROM soum_login_log where login_type='Customer' and login_by=soum_master_customer.cust_id  group by login_by)count1
																 from soum_master_customer where 1=1 and cust_id IN (".$customer_list.')'.$cond." order by cust_id desc LIMIT $start_from, $num_rec_per_page";
																//echo $sql1;
																$res=$db->query($sql1);
																//$i=1;
																...
																<?php
																 ...
																 $sql1="select *,(SELECT count(1) FROM soum_login_log where login_type='Customer' and login_by=soum_master_customer.cust_id  group by login_by)count1
																 from soum_master_customer where 1=1 and cust_id IN (".$customer_list.')'.$cond;
																	//echo $sql;
																  $res1=$db->query($sql1);
							...
							$sql = "select * from soum_master_customer where 1=1 and cust_id IN (".$customer_list.')'.$cond;
							...
							?>
								...
								<div class="tab-pane" id="tab-flip-three-1">
									...
									<?php
								     ...
								     $sql1="select *,(SELECT count(1) FROM soum_login_log where login_type='Customer' and login_by=soum_master_customer.cust_id  group by login_by)count1
									 from soum_master_customer where 1=1 ".$cond;
										//echo $sql;
									  $res1=$db->query($sql1);
									  while($row1=$res1->fetch_assoc())
									  {
