					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="dash-head clearfix mb20">
								<div class="left">
									<h3 class="mb5 text-light" style="margin-top:0px;">User <?php $type=$_REQUEST['type']; echo $type;?> </h3>
								</div>
						...
						<div class="col-md-12">
							<div class="dash-head clearfix mb20">
								<div class="left">
									<h3 class="mb5 text-light" style="margin-top:0px;">Todays Event
									<ul>									</h3>
<?php
$sql1="select
						...
						<!-- tab style -->
							<div class="clearfix tabs-fill">
								<ul class="nav nav-tabs">
									<li class="active">
									<a href="#tab-flip-one-1" data-toggle="tab">Customer</a></li>
									<li><a href="#tab-flip-two-1" data-toggle="tab">Dealer</a></li>
								</ul>
								<div class="tab-content">
									...
									<thead>
										<tr style="background: #38b4ee;color: #fff">
											...
											<th style="padding:5px;">Addres</th>
									...
									$type=$_REQUEST['type'];
										  	...
										  	$sql1="select * from soum_master_customer";
									...
									?>
										<tr>
											...
											<td><?=$row1['city'];?></td>
											<td><?=$row1['pincod'];?></td>
											<td><a class="link" href="../update-profile.php?cust_id=<?=$row1['cust_id'];?>&utype=Customer">EDIT</a><td>
										</tr>
									<?php
									}
...
<table class="table table-bordered invoice-table mb30" id="list-1">
									...
									<?php
										   ...
										   $sql1="select * from soum_master_dealer";
									...
									?>
										<tr>
											...
											<td><?=$row1['city'];?></td>
											<td><?=$row1['pincod'];?></td>
											<td><a class="link" href="../update-profile.php?cust_id=<?=$row1['cust_id'];?>&utype=Dealer">EDIT</a><td>
										</tr>
