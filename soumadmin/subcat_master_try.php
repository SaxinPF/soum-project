...
<script>
function edit(cat_id,catename,home,logo,active1,act)
{
										...
										?>
											<tr>
												...
												<td style="padding: 5px;">
													<button class="link btn-primary Edit" type="submit" style="margin:0px;padding: 2px 12px;" onclick="edit('<?=$row['prod_subcat_id'];?>','<?=$row['prod_subcat_desc'];?>','<?=$row['home_logo'];?>','<?=$row['logo'];?>','<?=$row['priority1'];?>','Edit')">Edit</button>
												</td>
											</tr>
										<?php 
										}	
