				...
				<div class="col-md-12" style="background:#fff;margin-bottom:20px;margin-top:15px;display:none;">
					...
					$search = '';
						 if(isset($_REQUEST['Submit1']))
						 {
                           ...
                           $cond=" and  concat(soum_prod_subsubcat.prod_subcat_desc,soum_prod_subcat.prod_subcat_desc,display,battry,os,processor,ram,colour,p_rom) like '%$search%'";
						 }
						?>
					<!-- #end row -->
					<div class="row">
						<div class="col-md-12">
							<div class="dash-head clearfix mb20 table-responsive">
								...
								<table class="auto-style2" id="list-1" style="width: 100%;font-size:13px !important">
									<thead>
										<tr style="background: #38b4ee;color: #fff">
                                          ...
                                          <th style="padding: 5px;" style="display:none;"></th>
								...
								$sql="select soum_prod_subsubcat.*,soum_prod_subcat.prod_subcat_desc brand from soum_prod_subsubcat,soum_prod_subcat
                                      where soum_prod_subsubcat.prod_subcat_id=soum_prod_subcat.prod_subcat_id and soum_prod_subsubcat.prod_subcat_id!=0 and soum_prod_subsubcat.category_type='phone' ".$cond;
							//	echo $sql;
								$res=$db->query($sql);
								$i=1;
								// echo '<pre>';
								...
								?>
										<tr>
											...
											<td style="padding: 5px;" class="auto-style4" valign="top" style="display:none;"></td>
