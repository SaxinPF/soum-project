					...
					<div class="row">
						...
						<div class="col-md-12" style="margin-top:30px;">
							<div class="dash-head clearfix mb20">
								<div class="left">
									<h4 class="mb5 text-light"><a name="top">Admin Advertisement(Power Bank)</a></h4>
								</div>
                                <div>
                                <a class="btn btn-primary mr5 waves-effect" href="admin_adv_power_bank.php?act=add" style="margin:0px;padding:6px 80px;float:right;">Add new</a>
                                </div>
							</div>
						</div>
					</div>

                  <?php include('admin_adv_ele_power_bank.php');?>
					...
					<div class="clearfix tabs-fill">
								...
								<div class="tab-content table-responsive">
									...
									if($type!='')
									{
								    $cond.=" and soum_product_master.poster_type='$type' and soum_product_master.trash!='delete' and soum_product_master.category_type='power_bank'";
									}
								...
								/* 	  echo '<pre>';
									...
									?>
										<tr>
											...
											<a class="link btn-primary Edit" href="admin_adv_power_bank.php?req_id=<?=$row['prod_id']?>&amp;act=edit" style="margin:0px;padding: 2px 12px;" >Edit</a>
