...
if($poster_type =='Admin'){
 header("location:soumadmin/admin_adv.php");
}
...
<label class="control-label">Customer Image *</label>
 ...
 <div class="mainhead container">
  <div class="headslog"><h1>Sell your used phone<span>Want to sell your phone? You are at the right place.<br>
Avail best rates of your phones by using our services.</span></h1>

Looks like you are not loggedin the site. Press <a href="#" data-toggle="modal" data-target="#exampleModal">Log In</a> to continue.
 </div>
  <div class="clearfix"></div>
