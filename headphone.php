...
<script>
 ...
 <div class="clearfix"></div>
   <?php
    $set_var_modal = 'No';
    $category_type_static ='headphone';
   include('elements/leftfilter.php');?>
 <div class="clearfix"></div>
 <div class="container mt-4 shop">
 <h2>Find Neckbands & Headphones</h2>
 <div class="clearfix"></div>
 <div class="row">
...
and soum_product_master.category_type = 'headphone'
...
<div class="text-center"> <?php
       		...
       		<div class="styled-pagination margin-bott-40">
                <ul>
                      <li><a  class="<?php if($active==1){ $class='active';} else { $class='prev1';} ?>"  href='headphone.php?page=1&<?=$params;?>'><span class="fa fa-angle-left"></span>&ensp;First</a></li>
 <?php
...
and soum_product_master.active=1 and soum_product_master.trash!='delete' and soum_product_master.dispatched_date >$time and soum_product_master.dealer_del_date >$time  and soum_product_master.prod_id!=0".$cond1." ".$cond2." ".$cond;
								...
								$total_pages = ceil($total_records / $num_rec_per_page);
                                   for ($i=1; $i<=$total_pages; $i++)
									...
									echo "<li><a class=".$class." href='headphone.php?page=".$i."&".$params1."'>".$i."</a></li>";
                                   }
                                   ?>
                                <li><a class="<?php if($active==$total_pages){ $class='active';} else { $class='next1';} ?>" href='headphone.php?page=<?=$total_pages."&".$params1;?>'>Last&ensp;<span class="fa fa-angle-right"></span></a></li>
                            </ul>
            </div> </div>
